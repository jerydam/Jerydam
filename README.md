...
- **Onboarding-first:** the best protocol is useless if nobody can get started. Faucets, gasless flows (ERC-4337), and social logins are my default toolkit.
- **Security-first:** I write code that survives audits — Slither and MythX live in my CI/CD pipelines.
- **Multi-chain by design:** I bridge EVM and ZK/resource-oriented chains rather than picking a side.
...
<div align="center">
  <a href="https://git.io/streak-stats"><img src="https://github-readme-streak-stats-cyan-pi.vercel.app?user=jerydam&theme=highcontrast&date_format=M%20j%5B%2C%20Y%5D" alt="GitHub Streak" /></a>
</div>
